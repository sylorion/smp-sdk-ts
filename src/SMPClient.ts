...
import { Service, EstimateAsset, Organization,Invoice, Estimate, SMPPayment, Signup,ForgotPassword, Profile } from "./controllers/index.js";
export class SMPClient {
  ...
  constructor(options: SMPClientOptions) { 
    ...
    this.forgotPassword = new ForgotPassword(this.httpApiClient);
