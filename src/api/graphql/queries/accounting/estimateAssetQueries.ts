...
const estimateAssetQueries = {
    ...
    GET_ESTIMATE_ASSETS: `
      query estimateAssets($pagination: PaginationInput, $sort: SortInput, $filter: [FilterInput!]) {
    ...
    GET_ESTIMATE_ASSET_BY_ID: `
      query estimateAssetByID($estimateAssetID: ID!) {
    ...
    GET_ESTIMATE_ASSETS_BY_IDS: `
      query estimateAssetsByIDs($estimateAssetIDs: [ID!]!) {
    ...
    GET_ESTIMATE_ASSET_BY_UNIQ_REF: `
      query estimateAssetByUniqRef($uniqRef: String!) {
    ...
    GET_ESTIMATE_ASSET_BY_SLUG: `
      query estimateAssetBySlug($slug: String!) {
    ...
    GET_ESTIMATE_ASSETS_BY_SLUGS: `
      query estimateAssetsBySlugs($slugs: [String!]!) {
