...
export class EngagementController {
   ...
   */
  async getEngagementsByConsultant(consultantUserId: string): Promise<Engagement[]> {
    const response = await this.apiClient.query(
   ...
   */
  async getEngagementsByOrganization(organizationId: string): Promise<Engagement[]> {
    const response = await this.apiClient.query(
   ...
   */
  async updateEngagement(engagementId: string, data: UpdateEngagementInput): Promise<Engagement> {
    const response = await this.apiClient.mutate(
   ...
   */
  async deleteEngagement(engagementId: string): Promise<Engagement> {
    const response = await this.apiClient.mutate(
   ...
   */
  async getEngagementReportByToken(token: string): Promise<EngagementReport> {
    const response = await this.apiClient.query(
