...
export class Organization {
   ...
   */
  async createMedia(input: CreateOrganizationMediaInput): Promise<OrganizationMedia> {
   ...
   */
  async updateMedia(organizationMediaID: string, input: UpdateOrganizationMediaInput): Promise<OrganizationMedia> {
   ...
   */
  async deleteMedia(organizationMediaID: string): Promise<boolean> {
