...
export class Service {
  ...
  async list(pagination?: any, sort?: any, filter?: any, admin?: boolean): Promise<ServiceEntity[]> {
  ...
  async getMediaById(serviceMediaID: string): Promise<ServiceMediaEntity> {
  ...
  async getMediaBySlug(slug: string): Promise<ServiceMediaEntity> {
  ...
  async getMediasByIds(serviceMediaIDs: string[]): Promise<ServiceMediaEntity[]> {
  ...
  async getMediasBySlugs(slugs: string[]): Promise<ServiceMediaEntity[]> {
  ...
  async getMediaByUniqRef(uniqRef: string): Promise<ServiceMediaEntity> {
  ...
  async update(serviceID: string, input: UpdateServiceInput): Promise<ServiceEntity> {
  ...
  async delete(serviceID: string): Promise<MutationResponse> {
  ...
  async createMedia(input: CreateServiceMediaInput): Promise<ServiceMediaEntity> {
  ...
  async updateMedia(serviceMediaID: string, input: UpdateServiceMediaInput): Promise<ServiceMediaEntity> {
  ...
  async deleteMedia(serviceMediaID: string): Promise<MutationResponse> {
