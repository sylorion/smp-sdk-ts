...
export class Media {
  ...
  async update(mediaID: string, input: UpdateMediaInput): Promise<MediaEntity> {
  ...
  async getById(mediaID: string): Promise<MediaEntity> {
  ...
  async getBySlug(slug: string): Promise<MediaEntity> {
  ...
  async getByIds(mediaIDs: string[]): Promise<MediaEntity[]> {
  ...
  async getBySlugs(slugs: string[]): Promise<MediaEntity[]> {
  ...
  async getByUniqRef(uniqRef: string): Promise<MediaEntity> {
