...
export class Asset {
  ...
  async delete(assetID: string): Promise<MutationResponse> {
  ...
  async getMediaById(assetMediaID: string): Promise<AssetMediaEntity> {
  ...
  async getMediasByIds(assetMediaIDs: string[]): Promise<AssetMediaEntity[]> {
  ...
  async createMedia(input: CreateAssetMediaInput): Promise<AssetMediaEntity> {
  ...
  async updateMedia(assetMediaID: string, input: UpdateAssetMediaInput): Promise<AssetMediaEntity> {
  ...
  async deleteMedia(assetMediaID: string): Promise<MutationResponse> {
