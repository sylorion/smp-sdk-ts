...
export declare const REVIEW_SCORE_MIN = 1;
export declare const REVIEW_SCORE_MAX = 5;
export declare const REVIEW_SCORE_STEP = 0.5;
export declare const REVIEW_REWARD_CREDITS = 10;
