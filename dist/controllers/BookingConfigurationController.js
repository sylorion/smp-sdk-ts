import { bookingConfigurationMutations } from '../api/graphql/mutations/command/bookingConfigurationMutations.js';
...
export class BookingConfigurationController {
     ...
     */
    async createBookingConfiguration(input) {
     ...
     */
    async updateBookingConfiguration(id, input) {
     ...
     */
    async getBookingConfiguration(id) {
     ...
     */
    async getBookingConfigurationByService(serviceId) {
     ...
     */
    async getBookingConfigurationsByUser(userId) {
