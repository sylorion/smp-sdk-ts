import { engagementMutations } from '../api/graphql/mutations/engagement/engagementMutations.js';
import { engagementQueries } from '../api/graphql/queries/engagement/engagementQueries.js';
// Re-export des types pour faciliter l'utilisation
export { EngagementStatus, EngagementPriority, TimeSlotType, TimeSlotStatus, TimeSlotPriority, EngagementReportStatus } from '../api/graphql/types/engagement/EngagementTypes.js';
export class EngagementController {
     ...
     */
    async getEngagementsByService(serviceId) {
     ...
     */
    async getEngagementsByConsultant(consultantUserId) {
     ...
     */
    async getEngagementsByOrganization(organizationId) {
     ...
     */
    async getEngagementsByEstimate(estimateId) {
     ...
     */
    async getEngagementReportByToken(token) {
     ...
     */
    async getEngagementReportsByEngagement(engagementId) {
     ...
     */
    async getEngagementReportsByConsultant(consultantUserId) {
     ...
     */
    async getEngagementReportsByOrganization(organizationId) {
     ...
     */
    async getEngagementReportsByPeriod(year, periodType, periodValue) {
