...
export declare class Invoice {
     ...
     */
    getBySeller(sellerOrganizationId: string): Promise<InvoiceResponse[]>;
    /**
     * Retrieves all invoices for a buyer organization
     */
    getByBuyer(buyerOrganizationId: string): Promise<InvoiceResponse[]>;
    /**
     * Retrieves all invoices for a buyer user
     */
    getByBuyerUser(buyerUserId: string): Promise<InvoiceResponse[]>;
    /**
