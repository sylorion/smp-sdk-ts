...
import type { ContractResponse, CreateContractInput, UpdateContractInput, SignContractInput, SendContractInput, VerifyTokenResponse } from '../types/Contract.js';
/**
...
export declare class Contract {
     ...
     */
    getByOrganizationId(organizationId: string): Promise<ContractResponse[]>;
    /**
