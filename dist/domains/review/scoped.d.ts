 ...
 */
export declare function reviewDomainForUser(client: APIClient, userID: string, signature: string): ReviewDomain;
/** Domaine Review avec un jeton utilisateur (mobile / navigateur). */
export declare function reviewDomainWithToken(client: APIClient, accessToken: string): ReviewDomain;
