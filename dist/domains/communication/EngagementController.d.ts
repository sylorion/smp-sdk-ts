...
import { Engagement, TimeSlot, EngagementReport, CreateEngagementInput, UpdateEngagementInput, CreateTimeSlotInput, UpdateTimeSlotInput, CreateEngagementReportInput, UpdateEngagementReportInput } from '../../types/communication/index.js';
export { Engagement, TimeSlot, EngagementReport, EngagementStatus, EngagementPriority, TimeSlotType, TimeSlotStatus, TimeSlotPriority, EngagementReportStatus, CreateEngagementInput, UpdateEngagementInput, CreateTimeSlotInput, UpdateTimeSlotInput, CreateEngagementReportInput, UpdateEngagementReportInput } from '../../types/communication/index.js';
export declare class EngagementController {
     ...
     */
    listByServiceId(serviceId: string): Promise<Engagement[]>;
    /**
