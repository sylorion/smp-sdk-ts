...
export class EngagementController {
     ...
     */
    async listByServiceId(serviceId, organizationId) {
        const response = await this.apiClient.query(engagementQueries.GET_ENGAGEMENTS_BY_SERVICE_ID, { serviceId, organizationId });
    ...
    async listByBuyerUserId(buyerUserId) {
        const response = await this.apiClient.query(engagementQueries.GET_ENGAGEMENTS_BY_BUYER, { buyerUserId });
     ...
     */
    async sendWorkReportNotification(data) {
        const response = await this.apiClient.mutate(engagementMutations.SEND_WORK_REPORT_NOTIFICATION, { data });
